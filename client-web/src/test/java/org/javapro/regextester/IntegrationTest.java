...
"        <link rel=\"stylesheet\" href=\"https://cdn.jsdelivr.net/npm/level-css-framework@0.5.3/css/level.min.css\">\n" +
"    </head>\n" +
"    <body>\n" +
"    <row>\n" +
...
public class IntegrationTest {
    @Test public void testUIModelUI() {
        RegexTesting model = new RegexTesting("f.o,bar,hello,world","f\\.o,(bar)","f\\\\.o,(bar)","$1",false);
        model.applyBindings();
        assertFalse(model.isMatches());
        assertEquals(model.getReplaced(),"bar,hello,world");
    }
}
